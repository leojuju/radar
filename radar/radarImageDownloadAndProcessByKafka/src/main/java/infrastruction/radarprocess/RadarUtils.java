...
import infrastruction.redarprocess.geo.G;
import infrastruction.redarprocess.geo.GeoUtils;
...
public class RadarUtils {
	...
	public static ImageInfo getInfo(BufferedImage originImage){
		String[] infoStrs = getInfoInStrings(originImage);
		return getInfoFromStrings(infoStrs);
	}
	...
	public static String[] getInfoInStrings(BufferedImage image) {
		...
		time[0]=numbers[0]+""+numbers[1]+""+numbers[2]+""+numbers[3];
		time[1]=numbers[4]+""+numbers[5];
		time[2]=numbers[6]+""+numbers[7];
		time[3]=numbers[8]+""+numbers[9];
		time[4]=numbers[10]+""+numbers[11];
		time[5]=numbers[12]+""+numbers[13];
		time[6]=numbers[14]+""+numbers[15]+""+numbers[16];
		time[7]=numbers[17]+"."+numbers[18];
		if(numbers[19]>-1){
			time[7]+="_"+numbers[19]+"."+numbers[20];
		}
		if(numbers[21]>-1){
			time[7]+="_"+numbers[21]+"."+numbers[22];
		}
