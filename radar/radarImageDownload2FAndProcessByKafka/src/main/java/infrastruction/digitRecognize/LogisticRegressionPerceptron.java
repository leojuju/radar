 ...
 * err����Ϊ-yln(output)-(1-y)ln(1-output)
 * @author Administrator
 *
 */
public class LogisticRegressionPerceptron implements Serializable{
	/**
	 * 
	 */
...
//	private double[] prewalt;
	 ...
	 * @param input_legnth
	 */
	public LogisticRegressionPerceptron(int input_length,int id){
		this.d=input_length;
		this.id=id;
...
//		prewalt=new double[input_length+1];
	...
	public LogisticRegressionPerceptron(int input_length,double rate,int id){
